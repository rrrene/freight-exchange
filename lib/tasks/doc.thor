  ...
  def schema_hash
    {
      ...
      "regions" => {
        :name => {:description => "Name der Region", :example => "Rhein/Ruhr"},
        :country_id => {:description => "Verweis auf das Land, zum dem die Region gehört", :example => 1},
      },
      "countries" => {
        :name => {:description => "Name des Landes", :example => "Germany"},
        :iso => {:description => "ISO-Ländercode des Landes", :example => "de"},
      },
      "stations" => {
        :name => {:description => "Name des Bahnhofs", :example => "Essen Hbf"},
        :country_id => {:description => "Verweis auf das Land, in dem der Bahnhof liegt", :example => 1},
      ...
      "simple_searches" => {
        ...
        :text => {:description => "Text mit allen für das Objekt relevanten Schlagwörtern", :example => "Essen Hbf Gefahrgut..."},
      },
      "search_recordings" => {
        :user_id => {:description => "Verweis auf den Benutzer, dem das Objekt gehört.", :example => 1},
        :query => {:description => "Suchbegriffe", :example => "Essen Hbf Gefahrgut"},
        :results => {:description => "Anzahl der Resultate", :example => 12},
        :parent_id => {:description => "Verweis auf das Elternobjekt", :example => ""},
      ...
      "site_infos" => {
        ...
        :name => {:description => "Name des Ortes", :example => "Essen Hbf"},
        :address => {:description => "Addresse", :example => "Musterstr. 21"},
        :address2 => {:description => "Addresse (Fortsetzung)", :example => "3. Etage"},
        :zip => {:description => "Postleitzahl", :example => "12345"},
        :city => {:description => "Ort", :example => "Musterstadt"},
