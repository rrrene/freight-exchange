  ...
  def schema_hash
    {
      ...
      "simple_searches" => {
        ...
        :text => {:description => "Text mit allen für das Objekt relevanten Schlagwörtern", :example => "Rotterdam Gefahrgut..."},
      },
      "search_recordings" => {
        :user_id => {:description => "Verweis auf den Benutzer, dem das Objekt gehört", :example => 1},
        :query => {:description => "Suchbegriffe", :example => "Rotterdam Gefahrgut"},
