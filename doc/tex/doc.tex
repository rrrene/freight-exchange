...
\include{schema/app_configs}
\include{schema/companies}
\include{schema/countries}
\include{schema/freights}
\include{schema/loading_spaces}
\include{schema/localized_infos}
\include{schema/matching_recordings}
\include{schema/people}
\include{schema/recordings}
\include{schema/regions}
\include{schema/regions_stations}
\include{schema/reviews}
\include{schema/search_recordings}
\include{schema/simple_searches}
\include{schema/site_infos}
\include{schema/stations}
\include{schema/user_roles}
\include{schema/user_roles_users}
\include{schema/users}
\clearpage
